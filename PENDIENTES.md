...
| Cobertura que **ve la pantalla** | ✅ `tests/visor`, 157 pruebas en un navegador real |
| Coropletas r7/r6 del visor | ⏳ §2.2 |
| P4 brigada de imagen | ⏳ Fase 2, solo contrato |

**2.382 pruebas** sin red y sin navegador (más 13 nocturnas contra las fuentes
vivas y 157 del visor, que abren Chromium), `ruff` y `mypy --strict` limpios,
