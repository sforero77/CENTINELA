...
**Abiertas:** T0.7 (benchmark exactextract), T1.1 (redes nacionales), T1.2 (texto exacto de la licencia de OurAirports), T1.3 (HDX/HXL), T2.1–T2.4 (brigada), T3.1 (embeddings). Ninguna bloquea la operación.
