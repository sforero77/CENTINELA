...
| Inyección de dependencias | Todo lo que toca la red recibe un `Fetcher`; `FixtureFetcher` es lo que hace que 2.283 pruebas corran sin red. Las raices de `events/` y `reports/` se inyectan para que las pruebas no escriban en el repositorio. |
