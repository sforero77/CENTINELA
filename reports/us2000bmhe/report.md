...
| Vías primarias y secundarias en MMI≥7 | 9 km |
| Vías locales en MMI≥7 | 110 km |
| Superficie construida en MMI≥7 | 0,9 km² |

El satélite detecta **1,9 veces** más superficie construida de la que explicarían las 4.400 edificaciones registradas en MMI≥7. La diferencia suele ser asentamiento informal o zona rural dispersa sin mapear: **el conteo de edificaciones se queda corto ahí, y la superficie construida no**.

Las cifras de esta tabla van redondeadas a dos cifras significativas, que es la precisión que un modelo de exposición sostiene. Las exactas están en el CSV municipal y en `report.json`.

De la población en intensidad MMI≥7, alrededor de **800** personas tienen 65 años o más.
...
- **Licuefacción.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de cobertura areal por licuefacción según `zhu_2017_general_model.tif`: **13 mil**. USGS declara para este evento alerta **amarilla**, con 4.800 expuestas.
