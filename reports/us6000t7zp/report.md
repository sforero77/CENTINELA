...
- **Deslizamiento.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de probabilidad de deslizamiento: **29 mil**. USGS declara para este evento alerta **roja**, con 13 mil expuestas.
- **Licuefacción.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de cobertura areal por licuefacción: **560 mil**. USGS declara para este evento alerta **roja**, con 190 mil expuestas.
