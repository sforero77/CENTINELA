...
| Vías primarias y secundarias en MMI≥7 | 650 km |
| Vías locales en MMI≥7 | 4.200 km |
| Superficie construida en MMI≥7 | 46,8 km² |

Las cifras de esta tabla van redondeadas a dos cifras significativas, que es la precisión que un modelo de exposición sostiene. Las exactas están en el CSV municipal y en `report.json`.

De la población en intensidad MMI≥7, alrededor de **89 mil** personas tienen 65 años o más.
...
- **Deslizamiento.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de probabilidad de deslizamiento según `jessee_2018_model.tif`: **2.400**. USGS declara para este evento alerta **naranja**, con 2.200 expuestas.
- **Licuefacción.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de cobertura areal por licuefacción según `zhu_2017_general_model.tif`: **67 mil**. USGS declara para este evento alerta **naranja**, con 12 mil expuestas.
