...
| Vías primarias y secundarias en MMI≥6 | 41 km |
| Vías locales en MMI≥6 | 460 km |
| Superficie construida en MMI≥6 | 4,9 km² |

Las cifras de esta tabla van redondeadas a dos cifras significativas, que es la precisión que un modelo de exposición sostiene. Las exactas están en el CSV municipal y en `report.json`.

De la población en intensidad MMI≥6, alrededor de **5.000** personas tienen 65 años o más.
...
- **Deslizamiento.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de probabilidad de deslizamiento: **1.100**.
- **Licuefacción.** Población en celdas de MMI≥6 donde el modelo espera ≥ 0,10 de cobertura areal por licuefacción: **21 mil**. USGS declara para este evento alerta **naranja**, con 17 mil expuestas.
