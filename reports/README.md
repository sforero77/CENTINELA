...
| `hilo.txt` | Borrador para redes. **Publicarlo requiere acción humana** (RF-07) |
| `mapa.png` | Mapa estático, variantes `general` y `prensa` |

Ningún renderizador recalcula cifras: todos derivan de `report.json`. Si el
