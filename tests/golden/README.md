...
versión que esta fixture destapo.

**G3 — Sin Ground Failure.** Que el reporte omite la sección con nota explicita
...
están marcadas `skip` con razón: **necesitan el activo `exposure_h3` de
Colombia**, que es P0 (Fase 0, semana 2). No están bloqueadas por fixtures.

Falta también congelar los **contenidos** de los productos —`cont_mmi.json` y
