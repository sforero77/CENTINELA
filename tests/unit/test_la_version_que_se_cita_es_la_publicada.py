...
Dos documentos publicados —el visor y la página de estado— usan la versión
más alta de ShakeMap del catálogo como ejemplo de que **un
ShakeMap se revisa muchas veces**. Es un buen ejemplo y por eso está en dos
